...
! $omp parallel do default(shared) private(i1,i2,i3,r1,r2) collapse(2)
      do concurrent (i3 = 2 : n3-1) local (i1,i2,r1,r2)
         do i2=2,n2-1
            do i1=1,n1
...
! $omp parallel do default(shared) private(i1,i2,i3,u1,u2) collapse(2)
      do concurrent (i3 = 2 : n3-1) local (i1,i2,u1,u2)
         do i2=2,n2-1
            do i1=1,n1
...
! $omp& private(j1,j2,j3,i1,i2,i3,x1,y1,x2,y2)
      do concurrent (j3 = 2 : m3j-1) local (j1,j2,i1,i2,i3,x1,y1,x2,y2)
         do  j2=2,m2j-1
            i3 = 2*j3-d3
            i2 = 2*j2-d2
...
! $omp parallel do default(shared) private(i1,i2,i3,z1,z2,z3) collapse(2)
         do concurrent (i3 = 1 : mm3-1) local (i1,i2,z1,z2,z3)
            do  i2=1,mm2-1
...
! $omp& reduction(+:s) reduction(max:rnmu)
      do concurrent (i3 = 2 : n3-1) local (i1,i2,a)
         do  i2=2,n2-1
            do  i1=2,n1-1
               s=s+r(i1,i2,i3)**2
               a=abs(r(i1,i2,i3))
...
! $omp parallel do default(shared) private(i1,i2,i3) collapse(2)
      do concurrent (i3=1:n3) local(i1,i2) 
         do  i2=1,n2
            do  i1=1,n1
               z(i1,i2,i3) = 0.0D0
            enddo
